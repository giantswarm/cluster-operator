...
func mainWithError() (err error) {
	...
	daemonCommand.PersistentFlags().String(f.Service.Provider.Kind, "", "Kind of the underlying virtualization/technology provider the service is deployed in - 'aws', 'azure' or 'kvm'.")
