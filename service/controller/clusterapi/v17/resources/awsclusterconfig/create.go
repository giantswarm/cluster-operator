...
func (r *Resource) EnsureCreated(ctx context.Context, obj interface{}) error {
	...
	if errors.IsNotFound(err) {
		...
		newAWSClusterConfig := r.constructAWSClusterConfig(cr, versionBundles)
	...
	newAWSClusterConfig := r.mapClusterToAWSClusterConfig(*presentAWSClusterConfig, cr, versionBundles)
...
func (r *Resource) mapClusterToAWSClusterConfig(awsClusterConfig corev1alpha1.AWSClusterConfig, cr clusterv1alpha1.Cluster, versionBundles []versionbundle.Bundle) corev1alpha1.AWSClusterConfig {
...
func (r *Resource) constructAWSClusterConfig(cr clusterv1alpha1.Cluster, versionBundles []versionbundle.Bundle) corev1alpha1.AWSClusterConfig {
	...
	return r.mapClusterToAWSClusterConfig(cc, cr, versionBundles)
}
