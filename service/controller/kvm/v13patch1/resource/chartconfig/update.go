...
import (
	...
	"github.com/giantswarm/cluster-operator/pkg/v13patch1/chartconfig"
	"github.com/giantswarm/cluster-operator/pkg/v13patch1/key"
	kvmkey "github.com/giantswarm/cluster-operator/service/controller/kvm/v13patch1/key"
)
