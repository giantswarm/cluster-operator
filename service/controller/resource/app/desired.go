...
func (r *Resource) newApp(cc controllercontext.Context, cr apiv1alpha3.Cluster, appSpec key.AppSpec, userConfig g8sv1alpha1.AppSpecUserConfig) *g8sv1alpha1.App {
