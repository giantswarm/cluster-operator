...
func (c *CoreV1alpha1Client) ClusterNetworkConfigs(namespace string) ClusterNetworkConfigInterface {
	return newClusterNetworkConfigs(c, namespace)
}
